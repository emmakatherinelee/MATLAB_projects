...
%simulates motion of elastic net, with initial displacement in the center
%has additional aesthetic features purely for design
...
z0sheet = makez0sheet(round(n/2)-3,n,p);
z  = z0sheet((1:n),:);
z = single(z(:));
